...
ROS implmentiert eine themenbasierte Registrierung (topic based), andere Pub/Sub Systeme eine parameterbasierte (content based).

![RoboterSystem](./img/08_ROS_Kommunikation/TurtlesSimMitKey.png)<!-- width="100%" -->
