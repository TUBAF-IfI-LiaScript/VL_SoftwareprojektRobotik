...
![RoboterSystem](./image/10_Sensordatenhandling/GP2y0a21MeasurementCharacteristic.png)<!-- width="50%" -->
...
![RoboterSystem](./image/10_Sensordatenhandling/PolynomApproximation.png)<!-- width="100%" -->
...
![RoboterSystem](./image/10_Sensordatenhandling/medianfilter.png)<!-- width="100%" -->
...
![RoboterSystem](./image/10_Sensordatenhandling/GP2D120Sensor.png "Störabhängigkeit eines infrarot-lichtbasierten Distanzsensors in Bezug auf externe Beleuchtung")<!-- width="100%" -->
...
![RoboterSystem](./image/10_Sensordatenhandling/GP2D120FilterResult.png "Zeitliches Verhalten verschiedener Tests - Fligner (links), Mann-Whitney U (rechts))")<!-- width="80%" -->
