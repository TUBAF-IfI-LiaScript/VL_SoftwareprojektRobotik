...
[![LiaScript](https://raw.githubusercontent.com/LiaScript/LiaScript/master/badges/course.svg)](https://liascript.github.io/course/?https://raw.githubusercontent.com/TUBAF-IfI-LiaScript/VL_SoftwareprojektRobotik/refs/heads/master/06_Sensordatenhandling/06_Sensordatenhandling.md)
...
| **Inhalte:**         | `Ebenen der Sensordatentransformation`                                                                                        |
| **Link auf GitHub:** | https://github.com/TUBAF-IfI-LiaScript/VL_SoftwareprojektRobotik/blob/master/06_Sensordatenhandling/06_Sensordatenhandling.md |
| **Autoren**          | @author                                                                                                                       |
...
![RoboterSystem](./images/GP2y0a21MeasurementCharacteristic.png)<!-- width="50%" -->
...
![RoboterSystem](./images/PolynomApproximation.png)<!-- width="100%" -->
...
![RoboterSystem](./images/medianfilter.png)<!-- width="100%" -->
...
![RoboterSystem](./images/GP2D120Sensor.png "Störabhängigkeit eines infrarot-lichtbasierten Distanzsensors in Bezug auf externe Beleuchtung")<!-- width="60%" -->

![RoboterSystem](./images/GP2D120FilterConfiguration.png "Konfiguration der Größe des Referenzsamples und des Sliding Windows und deren Auswirkung auf die korrekte Klassifikation (Kolmogoroff-Smirnow) (links Referenzdatensatz, rechts gestörte Messung jeweils mit unterschiedlicher Zahl von Samples)")<!-- width="80%" -->


![RoboterSystem](./images/GP2D120FilterResult.png "Zeitliches Verhalten verschiedener Tests - Fligner (links), Mann-Whitney U (rechts))")<!-- width="60%" -->
...
![RoboterSystem](./images/LaserScanner.png)<!--  style="width:60%; max-width:300px; min-width:600px"-->
